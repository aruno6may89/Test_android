...
// MonkeyTalkAPI.js generated by MonkeyTalk at 2014-05-15 08:34:54 MDT
 ...
 * @param  {String} expectedImagePath the project-relative path to an image file, which contains the expected appearance. If the file does not exist, it will be created from the current appearance of the component
 * @param  {int} tolerance the 'fuzziness' to apply to the match in terms of color and sharpness, where 0=perfect match and 10=maximum tolerance (defaults to '0')
 * @param  {String} failMessage the custom failure message

 * @returns void 
 */
MT.Verifiable.prototype.verifyImage = function(expectedImagePath, tolerance, failMessage) {
	return this.app.play(this, "verifyImage", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @param  {int} seconds how many seconds to wait before giving up and failing the command (defaults to 10).

 * @returns void 
 */
MT.Verifiable.prototype.waitFor = function(seconds) {
	return this.app.play(this, "waitFor", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @returns void 
 */
MT.Verifiable.prototype.waitForNot = function(seconds) {
	return this.app.play(this, "waitForNot", MT.getArgList(arguments), MT.getModifiers(arguments));
};
...
MT.Device.prototype = new MT.Verifiable;
 ...
 * @param  {int} x x-coordinate of the tap, in component coords
 * @param  {int} y y-coordinate of the tap, in component coords

 * @returns void 
 */
MT.View.prototype.tap = function(x, y) {
 ...
 * @class
 * @extends MT.View
 * @param app The MT.Application containing this WebView
 * @param monkeyId A monkeyId or ordinal
 */
MT.WebView = function(app, monkeyId) {
	MT.View.call(this, app, monkeyId);
	this.componentType = "WebView";	
};

MT.WebView.prototype = new MT.View;

/**
 * 
 * @param monkeyId the monkeyId (String) or ordinal (int) for which to search. 
 * @returns {MT.WebView} the upper-left-most visible WebView matching the supplied monkeyId or ordinal
 */
MT.Application.prototype.webView = function(monkeyId) {
	if (!monkeyId) {
		monkeyId = "";
	}
	return new MT.WebView(this, monkeyId);
};
 ...
 * @returns void 
 */
MT.WebView.prototype.scroll = function(x, y) {
 ...
 * @returns void 
 */
MT.ItemSelector.prototype.longSelect = function(value) {
	return this.app.play(this, "longSelect", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @param  {int} index the index of the row to scroll to.

 * @returns void 
 */
MT.Table.prototype.scrollToIndex = function(index) {
	return this.app.play(this, "scrollToIndex", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @class
 * @extends MT.ItemSelector
 * @param app The MT.Application containing this Grid
 * @param monkeyId A monkeyId or ordinal
 */
MT.Grid = function(app, monkeyId) {
	MT.ItemSelector.call(this, app, monkeyId);
	this.componentType = "Grid";	
};

MT.Grid.prototype = new MT.ItemSelector;

/**
 * 
 * @param monkeyId the monkeyId (String) or ordinal (int) for which to search. 
 * @returns {MT.Grid} the upper-left-most visible Grid matching the supplied monkeyId or ordinal
 */
MT.Application.prototype.grid = function(monkeyId) {
	if (!monkeyId) {
		monkeyId = "";
	}
	return new MT.Grid(this, monkeyId);
};
 ...
 * @returns void 
 */
MT.Grid.prototype.scrollToIndex = function(index) {
	return this.app.play(this, "scrollToIndex", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @returns void 
 */
MT.Grid.prototype.scroll = function(x, y) {
	return this.app.play(this, "scroll", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @returns void 
 */
MT.Debug.prototype.globals = function() {
	return this.app.play(this, "globals", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @param  {String} filter (optional) a wildcard pattern to filter by component type (ex: But* would show only Button and ButtonSelector components in the tree). Defaults to all components.
 * @param  {String} format (optional) the output format (text or json). Defaults to text.

 * @returns void 
 */
MT.Debug.prototype.tree = function(filter, format) {
	return this.app.play(this, "tree", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @class
 * @extends MT.MTObject
 * @param app The MT.Application containing this Globals
 * @param monkeyId A monkeyId or ordinal
 */
MT.Globals = function(app, monkeyId) {
	MT.MTObject.call(this, app, monkeyId);
	this.componentType = "Globals";	
};

MT.Globals.prototype = new MT.MTObject;

/**
 * 
 * @param monkeyId the monkeyId (String) or ordinal (int) for which to search. 
 * @returns {MT.Globals} the upper-left-most visible Globals matching the supplied monkeyId or ordinal
 */
MT.Application.prototype.globals = function(monkeyId) {
	if (!monkeyId) {
		monkeyId = "";
	}
	return new MT.Globals(this, monkeyId);
};
 ...
 * @param  {String} args the global variables, in the form of: var=val var2=val2

 * @returns void 
 */
MT.Globals.prototype.define = function(args) {
	return this.app.play(this, "define", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @returns void 
 */
MT.Globals.prototype.set = function(args) {
	return this.app.play(this, "set", MT.getArgList(arguments), MT.getModifiers(arguments));
};
 ...
 * @param  {int} timeout how long to wait for the app to restart (in ms)

 * @returns void 
 */
MT.App.prototype.restart = function(timeout) {
	return this.app.play(this, "restart", MT.getArgList(arguments), MT.getModifiers(arguments));
};
